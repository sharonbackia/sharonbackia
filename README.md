...
- 🔭 Focused on Machine Learning, Deep Learning, Data Analytics & Generative AI
- 🌱 Continuously learning and building
- 🥈 2nd Place — Paper Presentation, Techisetz '25
- 🤖 Completed an AI & ML Virtual Internship

## Tech Stack

**Languages & ML**
`Python` · `Machine Learning` · `Deep Learning` · `TensorFlow` · `PyTorch` · `Keras` · `scikit-learn` · `Pandas` · `NumPy`

**Generative AI**
`OpenAI` · `Computer Vision` · `Advanced ML`

**Tools & Platforms**
`Git` · `GitHub` · `Jupyter` · `MQTT`

## Featured Projects

- 🤖 **Smart Glove — Gesture to Voice**
  A wearable system translating hand gestures into voice output to support communication. `Embedded Systems` `ML` `Accessibility Tech`

- 🧬 **Disease Outbreak Prediction**
  Predicting potential disease outbreaks from historical data using predictive modeling. `Predictive Modeling` `Time Series` `Public Health`

- 🏠 **Smart Home Automation Hub**
  IoT-based automation system integrating smart devices, MQTT communication, and intelligent data handling. `IoT` `MQTT` `Automation`

- 🎨 **Generative AI & GAN Projects**
  Exploring GANs for creative applications — anime character generation, function curve synthesis, and generative music visualizations. `GANs` `Creative AI` `Deep Learning`
